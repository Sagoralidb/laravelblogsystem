      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
          <div class="header-top-info mb-2 mb-md-0">
            <a href="tel:+23-345-67890">Call Us : <span>+8801938752495</span></a>
            <a href="mailto:mdsagorali033@gmail.com"><i class="fas fa-envelope mr-2"></i><span>mdsagorali033@gmail.com</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="widget">
          ...
          <h6><a href="mailto:mdsagorali33@gmail.com">mdsagorali33@gmail.com</a></h6>
          <a href="mob:+8801938752495"><span class="text-color h4">+8801938752495</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="footer-btm pt-4">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            Copyright &copy;<span id="currentYear"></span>, Designed by <a href="javascript:void(0)"
            >Themefisher</a>&amp; Developed by <a href="https://www.youtube.com/c/w3techbd">w3techbd</a>
        </div>
